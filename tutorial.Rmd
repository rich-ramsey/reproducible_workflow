...
You don't need to use papaja() to write manuscripts in R markdown and you definitely don't need to follow the APA guidelines.
But since my lab does research in experimental psychology and cognitive neuroscience, it seemed a reasonable place to start.
...
Then I would add in a few extras that I mention below in my lab's workflow.
...
In other words, whatever analysis pipeline you use within R, you could always pair that with renv(), git, GitHub and papaja.
...
A tex file (i.e., LaTeX file) that is produced when outputing to pdf. 
...
Inside the manuscript folder, there is a subfolder called "supplementary", which contains a supplementary.Rmd file.
...
I don't have that much experience writing manuscripts in R Markdown, so it is still new to me at this point.
