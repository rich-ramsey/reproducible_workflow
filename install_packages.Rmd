...
controlled by renv(). See the renv() section of the tutorial for details.
...
packages for model building in brms used mainly in models.Rmd and effects.Rmd
files. Of course, if you build regression models in other packagesm such as lme4
you may want to skip this stuff.
